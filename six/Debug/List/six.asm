...
_main:
; .FSTART _main
; 0000 000B int value = 0;
; 0000 000C DDRA = 0x01;
;	value -> R16,R17
	__GETWRN 16,17,0
	LDI  R30,LOW(1)
	OUT  0x1A,R30
; 0000 000D ADMUX = 0x06;
	LDI  R30,LOW(6)
	OUT  0x7,R30
; 0000 000E ADCSRA = 0x87;
	LDI  R30,LOW(135)
	OUT  0x6,R30
; 0000 000F while (1) {
_0x3:
; 0000 0010     ADCSRA = 0xC7;
	LDI  R30,LOW(199)
	OUT  0x6,R30
...
_0x6:
	SBIS 0x6,4
	RJMP _0x6
; 0000 0012     value = (int)ADCL + ((int)ADCH << 8);
	IN   R30,0x4
	LDI  R31,0
	MOVW R26,R30
	IN   R30,0x5
	...
	ADC  R31,R27
	MOVW R16,R30
; 0000 0013     if(value < 512)
	__CPWRN 16,17,512
	BRGE _0x9
; 0000 0014         PORTA = 0x01;
	LDI  R30,LOW(1)
	RJMP _0xC
; 0000 0015     else PORTA = 0x00;
_0x9:
	LDI  R30,LOW(0)
_0xC:
	OUT  0x1B,R30
