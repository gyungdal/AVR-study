...
; 0000 000C interrupt [17] void timer_int0(void){
_timer_int0:
; .FSTART _timer_int0
	ST   -Y,R0
	ST   -Y,R1
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 000D     TCNT0 = 0x00;
	LDI  R30,LOW(0)
	OUT  0x32,R30
; 0000 000E     if(count++ == 6){
	MOV  R30,R4
	INC  R4
	CPI  R30,LOW(0x6)
	BRNE _0x4
; 0000 000F         count = 0x00;
	CLR  R4
; 0000 0010         if(i++ >= 99)
	MOV  R30,R5
	INC  R5
...
; 0000 0017 i = 0x00;
	CLR  R5
; 0000 0018 count = 0x00;
	CLR  R4
; 0000 0019 TIMSK = 0x01;
	LDI  R30,LOW(1)
	OUT  0x37,R30
; 0000 001A TCCR0 = 0x07;   //1024분주
	LDI  R30,LOW(7)
	OUT  0x33,R30
